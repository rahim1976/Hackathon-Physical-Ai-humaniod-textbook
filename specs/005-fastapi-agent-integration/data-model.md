# Data Model: OpenAI Agent with OpenRouter Integration

## Core Entities

### AgentThread
**Description**: Represents a single conversation thread with the OpenRouter agent
...
**Validation Rules**:
- `thread_id` must be a valid OpenRouter thread ID format
